...
\subsection{Experimental results on MICAGes dataset}
    ...
    %Table.\ref{tab:cross_feature_mica} compares all types of deep features regarding accuracy of our proposed algorithm. 
