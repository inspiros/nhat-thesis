...
\section{General framework}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item \textit{Training classifier}: Once $v$ transformations have been computed, the projected features in the common space of each view will be utilized to train a single predictive model $F$ (i.e. k-Nearest Neighbors - kNN). % So we will learn $N$ classifiers for $N$ views: $F_1, F_2, ..., F_v$.
        \end{enumerate}
